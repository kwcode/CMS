...
namespace DBCommon
{
    ...
    public abstract class DbHelperSQL
    {
        ...
        //static DbHelperSQL(string ConnectionName)
        //{
        ...
        /// <returns></returns>
        public static int ExecuteSqlTran(string connectionString, List<String> SQLStringList, int successNumber, List<SqlParameter[]> cmdParms)
        {
            using (SqlConnection conn = new SqlConnection(connectionString))
            {
                conn.Open();
        ...
        /// <param name="storedProcName">存储过程名</param>
        /// <returns>DataSet</returns>
        public static DataSet RunProcedures(string connectionString, string storedProcName, IDataParameter[] parameters = null)
        {
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
        ...
        public static object RunScalarProcedure(string connectionString, string storedProcName, IDataParameter[] parameters)
        {
        ...
        /// <returns>数据集</returns>
        public static DataSet ExcuteSqls(string connectionString, string sql, params SqlParameter[] parameters)
        {
            using (SqlConnection conn = new SqlConnection(connectionString))
            {
                DataSet ds = new DataSet();
