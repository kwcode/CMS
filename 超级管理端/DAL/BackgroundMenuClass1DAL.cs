...
namespace DAL
{
    ...
    /// </summary>
    public class BackgroundMenuClass1DAL
    {
        /// <summary>
        ///表名
        /// <summary>
        private static string TableName = "BackgroundMenuClass1";
        ...
        /// <param name="ID">ID</param>
        /// <param name="SelectIF">查询字段</param>
        public static BackgroundMenuClass1Entity Get_99(int ID, string SelectIF)
        {
            try
            {
                //参数Where条件
