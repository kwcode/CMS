...
namespace DAL
{
    ...
    public class TemplatesDAL
    {
        ...
        ///表名
        /// <summary>
        private static string TableName = "Templates";
        ...
        /// <param name="ID">ID</param>
        /// <param name="SelectIF">查询字段</param>
        public static TemplatesEntity Get_99(int ID, string SelectIF)
        {
            try
            {
                //参数Where条件
                ...
                return Get1<TemplatesEntity>(SelectIF, pramsWhere);
            }
            catch { return null; }
        }
        #endregion
