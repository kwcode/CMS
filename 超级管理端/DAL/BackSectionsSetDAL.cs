...
namespace DAL
{
    ...
    /// Create Time:2016-12-02 22:18
    /// </summary>
    public class BackSectionsSetDAL
    {
        /// <summary>
        ///表名
        /// <summary>
        private static string TableName = "BackSectionsSet";
        ...
        /// <param name="ID">ID</param>
        /// <param name="SelectIF">查询字段</param>
        public static BackSectionsSetEntity Get_99(int ID, string SelectIF)
        {
            try
            {
                //参数Where条件
                ...
                return Get1<BackSectionsSetEntity>(SelectIF, pramsWhere);
            }
            catch { return null; }
        }
        #endregion
