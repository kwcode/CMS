...
namespace DAL
{
    ...
    /// Create Time:2016-11-22 01:02
    /// </summary>
    public class ProductClass2DAL
    {
        /// <summary>
        ///表名
        /// <summary>
        private static string TableName = "ProductClass2";
        ...
        /// <param name="ID">ID</param>
        /// <param name="SelectIF">查询字段</param>
        public static ProductClass2Entity Get_99(int ID, string SelectIF)
        {
            try
            {
                //参数Where条件
                ...
                return Get1<ProductClass2Entity>(SelectIF, pramsWhere);
            }
            catch { return null; }
        }
        #endregion
