...
namespace DAL
{
    ...
    /// Create Time:2016-11-22 22:11
    /// </summary>
    public class ProductClass3DAL
    {
        /// <summary>
        ///表名
        /// <summary>
        private static string TableName = "ProductClass3";
        ...
        /// <param name="ID">ID</param>
        /// <param name="SelectIF">查询字段</param>
        public static ProductClass3Entity Get_99(int ID, string SelectIF)
        {
            try
            {
                //参数Where条件
                ...
                return Get1<ProductClass3Entity>(SelectIF, pramsWhere);
            }
            catch { return null; }
        }
        #endregion
