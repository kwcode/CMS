...
namespace DAL
{
    ...
    /// Create Time:2016-11-26 00:16
    /// </summary>
    public class SuperAdministratorDAL
    {
        /// <summary>
        ///表名
        /// <summary>
        private static string TableName = "SuperAdministrator";
        ...
        /// <param name="ID">ID</param>
        /// <param name="SelectIF">查询字段</param>
        public static SuperAdministratorEntity Get_99(int ID, string SelectIF)
        {
            try
            {
                //参数Where条件
                ...
                return Get1<SuperAdministratorEntity>(SelectIF, pramsWhere);
            }
            catch { return null; }
        }
        #endregion
        ...
        /// <returns></returns>
        public static SuperAdministratorEntity Login(string name, string pwd)
        {
            SuperAdministratorEntity entity = new SuperAdministratorEntity();
            try
            {
                SqlParameter[] pramsWhere =
                {
                ...
                entity = Get1<SuperAdministratorEntity>("*", pramsWhere);
