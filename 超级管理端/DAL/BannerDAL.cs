...
namespace DAL
{
    ...
    public class BannerDAL
    {
        ...
        ///表名
        /// <summary>
        private static string TableName = "Banner";
        ...
        /// <param name="ID">ID</param>
        /// <param name="SelectIF">查询字段</param>
        public static BannerEntity Get_99(int ID, string SelectIF)
        {
            try
            {
                //参数Where条件
                ...
                return Get1<BannerEntity>(SelectIF, pramsWhere);
            }
            catch { return null; }
        }
        #endregion
