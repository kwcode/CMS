...
namespace DAL
{
    ...
    public class ProductDAL
    {
        ...
        public static List<T> GetList<T>(string SelectIF, SqlParameter[] pramsWhere)
        {
            DataTable dt = DBCommon.DBHelper.GetDataTable2(DALUtil.ConnString, TableName, SelectIF, pramsWhere, "ID");
        ...
        /// <param name="strWhere">条件(AND a=1 and b=2)</param>
        /// <param name="OrderName">排序无需带Order by</param>
        public static List<T> GetPageList<T>(int PageIndex, int PageSize, string SelectIF, string strWhere)
        {
            DataTable dt = DBCommon.DBHelper.GetDataTablePage(DALUtil.ConnString, TableName, SelectIF, PageIndex, PageSize, strWhere, "ID DESC ");
            return DALUtil.ConvertDataTableToEntityList<T>(dt);
        }
        ...
        /// <param name="ID">ID</param>
        /// <param name="SelectIF">查询字段</param>
        public static ProductEntity Get_99(int ID, string SelectIF)
        {
            try
            {
                //参数Where条件
                ...
                return Get1<ProductEntity>(SelectIF, pramsWhere);
            }
            catch { return null; }
        }
        #endregion
