<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Templates_List.aspx.cs" Inherits="WEB.Admin.Template.Templates_List" %>
...
<body>
    <div class="g-div-e">
        <div class="t-tool">
            <div class="left">
                <a class="l-btn" onclick="PopShow('Templates_Add.aspx',{area: ['500px', '300px']})">
        ...
        <form id="form1" runat="server">
            <asp:GridView ID="gv_List" DataKeyNames="ID" CssClass="m-table" runat="server" AutoGenerateColumns="False" Width="100%">
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="模板编号(唯一值)">
                    ...
                    <asp:TemplateField HeaderText="操作">
                        ...
                        <ItemTemplate>
                            <a class="td-btn" onclick="PopShow('Templates_Modify.aspx?ID=<%#Eval("ID")%>',{area: ['500px', '300px']})">
