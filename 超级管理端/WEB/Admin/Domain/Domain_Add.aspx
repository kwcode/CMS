<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Domain_Add.aspx.cs" Inherits="WEB.Admin.Domain.Domain_Add" %>
        ...
        <div>
            <table class="ed-table">
                <tr>
                    ...
                    <td>
                        <input type="text" class="input100" runat="server" id="txtUserID" />
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" CssClass="red"
                            ...
                            ErrorMessage="关联UserID不能为空" SetFocusOnError="True">关联UserID不能为空</asp:RequiredFieldValidator>
