<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Article_List.aspx.cs" Inherits="WEB.GL.Article.Article_List" %>
            ...
            <asp:GridView ID="gv_List" DataKeyNames="ID" CssClass="m-table" runat="server" AutoGenerateColumns="False" Width="100%"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="分类">
                        ...
                        <ItemTemplate>
                            <asp:Literal ID="ltArticleClass1_ValueNum" runat="server" Text='<%#Eval("ArticleClass1_ValueNum")%>'></asp:Literal>
                        </ItemTemplate>
                    </asp:TemplateField>
                    ...
                    <asp:TemplateField HeaderText="操作" FooterText="操作">
                        ...
                        <ItemTemplate>
                            <a class="td-btn" href="Article_Modify.aspx?id=<%#Eval("ID")%>" target="_blank">
