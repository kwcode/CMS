...
{
    public partial class BackgroundMenuClass1_List : UICommon.BasePage_PM
    {
        ...
        public static object DoDelete(string jsonlist)
        {
            ...
            {
                int row_Del = DAL.BackgroundMenuClass1DAL.Delete_1(item);
                if (row_Del > 0)
                {
                    index++;
                }
        ...
        private void BindData()
        {
            ...
            List<Model.BackgroundMenuClass1Entity> entityList = DAL.BackgroundMenuClass1DAL.GetPageList<Model.BackgroundMenuClass1Entity>(PageIndex, PageSize, "*", sqlWhere.ToString());
