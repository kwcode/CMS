<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Banner_List.aspx.cs" Inherits="WEB.GL.Banner.Banner_List" %>
...
<body>
    <div class="g-div-e">
        <div class="t-tool">
            <div class="left">
                <a class="l-btn" onclick="PopShow('Banner_Add.aspx',{area: ['500px', '400px']})">
            ...
            <asp:GridView ID="gv_List" DataKeyNames="ID" CssClass="m-table" runat="server" AutoGenerateColumns="False" Width="100%">
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="名称">
                        ...
                        <ItemTemplate>
                            <div class="imgbox">
                                <asp:Image ImageUrl='<%#Eval("ImagePath")%>' runat="server" CssClass="titlepictures" ID="ImagePath" />
                            </div>
                            <div class="txtbox">
