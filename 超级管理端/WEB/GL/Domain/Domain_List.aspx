<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Domain_List.aspx.cs" Inherits="WEB.GL.Domain.Domain_List" %>
            ...
            <asp:GridView ID="gv_List" DataKeyNames="ID" CssClass="m-table" runat="server"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="域名">
                        ...
                        <ItemTemplate>
                            <asp:Literal ID="DomainName" runat="server" Text='<%#Eval("DomainName")%>'></asp:Literal>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="到期时间">
                        <ItemStyle HorizontalAlign="Left" />
                        <ItemTemplate>
                            <asp:Literal ID="EndDate" runat="server" Text='<%#Eval("EndDate")%>'></asp:Literal>
                        </ItemTemplate>
                    </asp:TemplateField>
                    ...
                    <asp:TemplateField HeaderText="操作">
                        ...
                        <ItemTemplate>
                            ...
                            <a class="td-btn" href="/GL/GLToGL.aspx?UserID=<%#Eval("ID")%>" target="_blank">
