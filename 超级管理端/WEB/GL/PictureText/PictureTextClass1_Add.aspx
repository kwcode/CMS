<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PictureTextClass1_Add.aspx.cs" Inherits="WEB.GL.PictureText.PictureTextClass1_Add" %>
        ...
        <div>
            ...
            <table class="ed-table">
                <tr>
                    ...
                    <td> 
                         <asp:DropDownList runat="server" ID="ddlBackSectionsSet" AutoPostBack="true" 
                            OnSelectedIndexChanged="ddlBackSectionsSet_SelectedIndexChanged"></asp:DropDownList>
