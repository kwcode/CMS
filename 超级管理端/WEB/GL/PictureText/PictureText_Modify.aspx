<%@ Page Language="C#" ValidateRequest="false" AutoEventWireup="true" CodeBehind="PictureText_Modify.aspx.cs" Inherits="WEB.GL.PictureText.PictureText_Modify" %>
        ...
        <div>
            ...
            <table class="ed-table">
                ...
                <tr>
                    ...
                    <td>
                        <asp:DropDownList runat="server" ID="ddlPictureTextClass1">
                        </asp:DropDownList>
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" CssClass="red"
