...
{
    public partial class PictureTextClass1_List : UICommon.BasePage_PM
    {
        ...
        public static object DoDelete(string jsonlist)
        {
            ...
            {
                int row_Del = DAL.PictureTextClass1DAL.Delete_1(item);
                if (row_Del > 0)
                {
                    index++;
                }
        ...
        private void BindData()
        {
            ...
            TotalCount = DAL.PictureTextClass1DAL.GetRecordCount(sqlWhere.ToString());
            List<Model.PictureTextClass1Entity> productList = DAL.PictureTextClass1DAL.GetPageList<Model.PictureTextClass1Entity>(PageIndex, PageSize, "*", sqlWhere.ToString(), "OrderNum");
