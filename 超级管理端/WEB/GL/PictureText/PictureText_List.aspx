<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PictureText_List.aspx.cs" Inherits="WEB.GL.PictureText.PictureText_List" %>
...
<body>
    <div class="g-div-e">
        <div class="t-tool">
            <div class="left">
                <a class="l-btn" target="_blank" href="PictureText_Add.aspx">
            ...
            <div class="right" style="margin-right: 20px; padding: 0px 10px;">
                <div class="searchbox clearfix">
                    <select runat="server" class="selclass1" id="ddlPictureTextClass1"></select>
            ...
            <asp:GridView ID="gv_List" DataKeyNames="ID" CssClass="m-table" runat="server"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="分类">
                        <ItemStyle HorizontalAlign="Center" Width="50" />
                        <ItemTemplate>
                            <asp:Literal ID="PictureTextClass1_ValueNum" runat="server" Text='<%#Eval("PictureTextClass1_ValueNum")%>'></asp:Literal>
                        </ItemTemplate>
                    </asp:TemplateField>
                    ...
                    <asp:TemplateField HeaderText="名称">
                        ...
                        <ItemTemplate>
                            <asp:Literal runat="server" ID="ltImagePath" Text='<%#Eval("ImagePath")%>'></asp:Literal>
                            <div class="txtbox">
                    ...
                    <asp:TemplateField HeaderText="ValueNum">
                        <ItemStyle HorizontalAlign="Center" Width="50" />
                        <ItemTemplate>
                    ...
                    <asp:TemplateField HeaderText="操作" FooterText="操作">
                        ...
                        <ItemTemplate>
                            <a class="td-btn" href="PictureText_Modify.aspx?id=<%#Eval("ID")%>" target="_blank">
