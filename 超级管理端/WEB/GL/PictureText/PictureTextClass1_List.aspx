<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PictureTextClass1_List.aspx.cs" Inherits="WEB.GL.PictureText.PictureTextClass1_List" %>
...
<body>
    <div class="g-div-e">
        <div class="t-tool">
            <div class="left">
                <a class="l-btn" onclick="PopShow('PictureTextClass1_Add.aspx',{area: ['500px', '330px']})">
            ...
            <asp:GridView ID="gv_List" DataKeyNames="ID" CssClass="m-table" runat="server" AutoGenerateColumns="False" Width="100%">
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="操作">
                        ...
                        <ItemTemplate>
                            <a class="td-btn" onclick="PopShow('PictureTextClass1_Modify.aspx?ID=<%#Eval("ID")%>',{area: ['500px', '330px']})">
