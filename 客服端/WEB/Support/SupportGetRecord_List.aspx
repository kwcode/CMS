<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SupportGetRecord_List.aspx.cs" Inherits="WEB.Support.SupportGetRecord_List" %>
        ...
        <form id="form1" runat="server">
            <asp:GridView ID="gv_List" DataKeyNames="KeyID" CssClass="m-table" runat="server" AutoGenerateColumns="False" Width="100%">
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="请求内容">
                        <ItemStyle HorizontalAlign="Left" />
                        <ItemTemplate>
                            <asp:Literal ID="GetContent" runat="server" Text='<%#Eval("GetContent")%>'></asp:Literal>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="返回的答库ID">
                        <ItemStyle HorizontalAlign="Left" />
                        <ItemTemplate>
                            <asp:Literal ID="SetSupportID" runat="server" Text='<%#Eval("SetSupportID")%>'></asp:Literal>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="请求时间" FooterText="请求时间">
                        <ItemStyle HorizontalAlign="Left" Width="120" />
                        <ItemTemplate>
                            <asp:Literal ID="AddTime" runat="server" Text='<%#Eval("AddTime")%>'></asp:Literal>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="请求者" FooterText="请求者">
                        <ItemStyle HorizontalAlign="Left" Width="120" />
                        <ItemTemplate>
                            <asp:Literal ID="GetUserID" runat="server" Text='<%#Eval("GetUserID")%>'></asp:Literal>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="请求者IP" FooterText="请求者IP">
                        <ItemStyle HorizontalAlign="Left" Width="120" />
                        <ItemTemplate>
                            <asp:Literal ID="GetIP" runat="server" Text='<%#Eval("GetIP")%>'></asp:Literal>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="请求者信息" FooterText="请求者信息">
                        <ItemStyle HorizontalAlign="Center" />
                        <ItemTemplate>
                            <asp:Literal ID="GetBrowserInfo" runat="server" Text='<%#Eval("GetBrowserInfo")%>'></asp:Literal>
                        </ItemTemplate>
                    </asp:TemplateField>
