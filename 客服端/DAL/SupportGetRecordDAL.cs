...
namespace DAL
{
    ...
    /// Create Time:2017-01-12 10:31
    /// </summary>
    public class SupportGetRecordDAL
    {
        /// <summary>
        ///表名
        /// <summary>
        private static string TableName = "SupportGetRecord";
        ...
        /// <param name="ID">ID</param>
        /// <param name="SelectIF">查询字段</param>
        public static SupportGetRecordEntity Get_99(int ID, string SelectIF)
        {
            try
            {
                //参数Where条件
                ...
                return Get1<SupportGetRecordEntity>(SelectIF, pramsWhere);
            }
            catch { return null; }
        }
        #endregion
