...
namespace DAL
{
    ...
    /// </summary>
    public class UserPictureBookDAL
    {
        /// <summary>
        ///表名
        /// <summary>
        private static string TableName = "UserPictureBook";
        ...
        /// <param name="ID">ID</param>
        /// <param name="SelectIF">查询字段</param>
        public static UserPictureBookEntity Get_99(int ID, string SelectIF)
        {
            try
            {
                //参数Where条件
                ...
                return Get1<UserPictureBookEntity>(SelectIF, pramsWhere);
            }
            catch { return null; }
        }
        #endregion
