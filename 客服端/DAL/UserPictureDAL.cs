...
namespace DAL
{
    ...
    /// Create Time:2016-12-10 14:47
    /// </summary>
    public class UserPictureDAL
    {
        /// <summary>
        ///表名
        /// <summary>
        private static string TableName = "UserPicture";
        ...
        /// <returns>成功返回影响行数,失败返回0</returns>
        public static int Modify(SqlParameter[] pramsModify, int id,int UserID)
        {
        ...
        /// <param name="ID">ID</param>
        /// <param name="SelectIF">查询字段</param>
        public static UserPictureEntity Get_99(int ID, string SelectIF)
        {
            try
            {
                //参数Where条件
                ...
                return Get1<UserPictureEntity>(SelectIF, pramsWhere);
            }
            catch { return null; }
        }
        #endregion
