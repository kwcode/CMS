...
namespace DAL
{
    ...
    /// </summary>
    public class CaseClass1DAL
    {
        /// <summary>
        ///表名
        /// <summary>
        private static string TableName = "CaseClass1";
        ...
        /// <param name="ID">ID</param>
        /// <param name="SelectIF">查询字段</param>
        public static CaseClass1Entity Get_99(int ID, string SelectIF)
        {
            try
            {
                //参数Where条件
                ...
                return Get1<CaseClass1Entity>(SelectIF, pramsWhere);
            }
            catch { return null; }
        }
        #endregion
