...
namespace DAL
{
    ...
    /// Create Time:2016-12-04 14:48
    /// </summary>
    public class SolutionClass1DAL
    {
        /// <summary>
        ///表名
        /// <summary>
        private static string TableName = "SolutionClass1";
        ...
        /// <param name="ID">ID</param>
        /// <param name="SelectIF">查询字段</param>
        public static SolutionClass1Entity Get_99(int ID, string SelectIF)
        {
            try
            {
                //参数Where条件
                ...
                return Get1<SolutionClass1Entity>(SelectIF, pramsWhere);
            }
            catch { return null; }
        }
        #endregion
