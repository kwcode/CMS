...
namespace DAL
{
    ...
    /// Create Time:2016-12-09 23:58
    /// </summary>
    public class UserPictureSpecDAL
    {
        /// <summary>
        ///表名
        /// <summary>
        private static string TableName = "UserPictureSpec";
        ...
        /// <summary>
        /// Width,Height,PictureType,ID
        /// </summary>
        /// <typeparam name="T"></typeparam>
        /// <param name="ValueNum"></param>
        /// <param name="UserID"></param>
        /// <returns></returns>
        public static List<T> GetList2<T>(int ValueNum, int UserID)
        {
            SqlParameter[] pramsWhere =
				{
            ...
            string SelectIF = "Width,Height,PictureType,ID";
            DataTable dt = DBCommon.DBHelper.GetDataTable2(DALUtil.ConnString, TableName, SelectIF, pramsWhere);
            return DALUtil.ConvertDataTableToEntityList<T>(dt);
        }
        #endregion
        ...
        /// <param name="ID">ID</param>
        /// <param name="SelectIF">查询字段</param>
        public static UserPictureSpecEntity Get_99(int ID, string SelectIF)
        {
            try
            {
                //参数Where条件
                ...
                return Get1<UserPictureSpecEntity>(SelectIF, pramsWhere);
            }
            catch { return null; }
        }
        #endregion
