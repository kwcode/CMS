...
namespace DAL
{
    ...
    /// </summary>
    public class AnnounceClass1DAL
    {
        /// <summary>
        ///表名
        /// <summary>
        private static string TableName = "AnnounceClass1";
        ...
        /// <param name="ID">ID</param>
        /// <param name="SelectIF">查询字段</param>
        public static AnnounceClass1Entity Get_99(int ID, string SelectIF)
        {
            try
            {
                //参数Where条件
                ...
                return Get1<AnnounceClass1Entity>(SelectIF, pramsWhere);
            }
            catch { return null; }
        }
        #endregion
