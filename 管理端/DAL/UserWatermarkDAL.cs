...
namespace DAL
{
    ...
    /// Create Time:2017-01-02 02:14
    /// </summary>
    public class UserWatermarkDAL
    {
        /// <summary>
        ///表名
        /// <summary>
        private static string TableName = "UserWatermark";
        ...
        /// <param name="SelectIF">查询字段</param>
        public static UserWatermarkEntity Get_98(int UserID, string SelectIF)
        {
            try
            {
                //参数Where条件
                ...
                return Get1<UserWatermarkEntity>(SelectIF, pramsWhere);
            }
            catch { return null; }
        }
        #endregion
