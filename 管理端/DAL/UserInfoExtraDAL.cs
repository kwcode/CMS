...
namespace DAL
{
    ...
    /// Create Time:2016-12-28 23:53
    /// </summary>
    public class UserInfoExtraDAL
    {
        /// <summary>
        ///表名
        /// <summary>
        private static string TableName = "UserInfoExtra";
        ...
        /// <returns>成功返回影响行数,失败返回0</returns>
        public static int Modify(SqlParameter[] pramsModify, int UserID)
        {
        ...
        /// <param name="ID">ID</param>
        /// <param name="SelectIF">查询字段</param>
        public static UserInfoExtraEntity Get_99(int UserID, string SelectIF)
        {
            try
            {
                //参数Where条件
                ...
                return Get1<UserInfoExtraEntity>(SelectIF, pramsWhere);
            }
            catch { return null; }
        }
        #endregion
        ...
        public static int Delete_1(int ID)
        {
            SqlParameter[] pramsWhere =
			{
				DALUtil.MakeInParam("@UserID",SqlDbType.Int,4,ID)
			 };
            return DBCommon.DBHelper.Delete(DALUtil.ConnString, TableName, pramsWhere);
        }
        #endregion
