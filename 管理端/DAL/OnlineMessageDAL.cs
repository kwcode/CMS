...
namespace DAL
{
    ...
    /// Create Time:2016-11-25 22:52
    /// </summary>
    public class OnlineMessageDAL
    {
        /// <summary>
        ///表名
        /// <summary>
        private static string TableName = "OnlineMessage";
        ...
        /// <param name="ID">ID</param>
        /// <param name="SelectIF">查询字段</param>
        public static OnlineMessageEntity Get_99(int ID, string SelectIF)
        {
            try
            {
                //参数Where条件
                ...
                return Get1<OnlineMessageEntity>(SelectIF, pramsWhere);
            }
            catch { return null; }
        }
        #endregion
