...
namespace DAL
{
    ...
    /// Create Time:2016-12-25 20:52
    /// </summary>
    public class NavigationBarDAL
    {
        /// <summary>
        ///表名
        /// <summary>
        private static string TableName = "NavigationBar";
        ...
        /// <param name="ID">ID</param>
        /// <param name="SelectIF">查询字段</param>
        public static NavigationBarEntity Get_99(int ID, string SelectIF)
        {
            try
            {
                //参数Where条件
                ...
                return Get1<NavigationBarEntity>(SelectIF, pramsWhere);
            }
            catch { return null; }
        }
        #endregion
