...
namespace DAL
{
    ...
    /// Create Time:2016-12-25 17:00
    /// </summary>
    public class WebFlowChartsDAL
    {
        /// <summary>
        ///表名
        /// <summary>
        private static string TableName = "WebFlowCharts";
        ...
        public static List<T> GetList<T>(string sqlText)
        {
            DataSet ds = DBCommon.DBHelper.GetDataSet(DALUtil.ConnString, sqlText);
            return DALUtil.ConvertDataTableToEntityList<T>(ds.Tables[0]);
        }
        ...
        /// <param name="ID">ID</param>
        /// <param name="SelectIF">查询字段</param>
        public static WebFlowChartsEntity Get_99(int ID, string SelectIF)
        {
            try
            {
                //参数Where条件
                ...
                return Get1<WebFlowChartsEntity>(SelectIF, pramsWhere);
            }
            catch { return null; }
        }
        #endregion
