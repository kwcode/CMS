...
namespace DAL
{
    ...
    /// Create Time:2016-11-21 01:12
    /// </summary>
    public class ProductClass1DAL
    {
        /// <summary>
        ///表名
        /// <summary>
        private static string TableName = "ProductClass1";
        ...
        /// <param name="ID">ID</param>
        /// <param name="SelectIF">查询字段</param>
        public static ProductClass1Entity Get_99(int ID, string SelectIF)
        {
            try
            {
                //参数Where条件
                ...
                return Get1<ProductClass1Entity>(SelectIF, pramsWhere);
            }
            catch { return null; }
        }
        #endregion
