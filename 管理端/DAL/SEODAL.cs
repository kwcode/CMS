...
namespace DAL
{
    ...
    public class SEODAL
    {
        ...
        ///表名
        /// <summary>
        private static string TableName = "SEO";
        ...
        /// <param name="ID">ID</param>
        /// <param name="SelectIF">查询字段</param>
        public static SEOEntity Get_99(int ID, string SelectIF)
        {
            try
            {
                //参数Where条件
                ...
                return Get1<SEOEntity>(SelectIF, pramsWhere);
            }
            catch { return null; }
        }
        public static SEOEntity Get_98(int UserID, string SelectIF)
        {
            try
            {
                //参数Where条件
