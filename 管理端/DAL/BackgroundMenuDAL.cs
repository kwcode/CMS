...
namespace DAL
{
    ...
    /// Create Time:2016-11-27 00:55
    /// </summary>
    public class BackgroundMenuDAL
    {
        /// <summary>
        ///表名
        /// <summary>
        private static string TableName = "BackgroundMenu";
        ...
        /// <param name="ID">ID</param>
        /// <param name="SelectIF">查询字段</param>
        public static BackgroundMenuEntity Get_99(int ID, string SelectIF)
        {
            try
            {
                //参数Where条件
                ...
                return Get1<BackgroundMenuEntity>(SelectIF, pramsWhere);
            }
            catch { return null; }
        }
        #endregion
