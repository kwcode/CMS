...
namespace DAL
{
    ...
    /// Create Time:2016-12-28 21:18
    /// </summary>
    public class OnlineServicesDAL
    {
        /// <summary>
        ///表名
        /// <summary>
        private static string TableName = "OnlineServices";
        ...
        /// <param name="ID">ID</param>
        /// <param name="SelectIF">查询字段</param>
        public static OnlineServicesEntity Get_99(int ID, string SelectIF)
        {
            try
            {
                //参数Where条件
                ...
                return Get1<OnlineServicesEntity>(SelectIF, pramsWhere);
            }
            catch { return null; }
        }
        #endregion
