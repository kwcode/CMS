...
namespace DAL
{
    ...
    /// </summary>
    public class UserPictureDetailDAL
    {
        /// <summary>
        ///表名
        /// <summary>
        private static string TableName = "UserPictureDetail";
        ...
        /// <param name="ID">ID</param>
        /// <param name="SelectIF">查询字段</param>
        public static UserPictureDetailEntity Get_99(int ID, string SelectIF)
        {
            try
            {
                //参数Where条件
                ...
                return Get1<UserPictureDetailEntity>(SelectIF, pramsWhere);
            }
            catch { return null; }
        }
        #endregion
