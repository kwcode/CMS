...
namespace DAL
{
    ...
    public class DomainDAL
    {
        ...
        public static DomainEntity Get_97(int UserID, string SelectIF, string OrderName = "")
        {
            try
            {
                //参数Where条件
                ...
                return Get1<DomainEntity>(SelectIF, pramsWhere, OrderName);
            }
            catch { return null; }
        }
        #endregion
