...
namespace DAL
{
    ...
    /// Create Time:2016-11-29 00:19
    /// </summary>
    public class PictureTextDAL
    {
        /// <summary>
        ///表名
        /// <summary>
        private static string TableName = "PictureText";
        ...
        /// <param name="ID">ID</param>
        /// <param name="SelectIF">查询字段</param>
        public static PictureTextEntity Get_99(int ID, string SelectIF)
        {
            try
            {
                //参数Where条件
                ...
                return Get1<PictureTextEntity>(SelectIF, pramsWhere);
            }
            catch { return null; }
        }
        #endregion
