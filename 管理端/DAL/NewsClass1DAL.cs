...
namespace DAL
{
    ...
    /// Create Time:2016-11-27 01:31
    /// </summary>
    public class NewsClass1DAL
    {
        /// <summary>
        ///表名
        /// <summary>
        private static string TableName = "NewsClass1";
        ...
        /// <param name="ID">ID</param>
        /// <param name="SelectIF">查询字段</param>
        public static NewsClass1Entity Get_99(int ID, string SelectIF)
        {
            try
            {
                //参数Where条件
                ...
                return Get1<NewsClass1Entity>(SelectIF, pramsWhere);
            }
            catch { return null; }
        }
        #endregion
