...
namespace DAL
{
    ...
    /// Create Time:2016-12-25 15:16
    /// </summary>
    public class WebFlowTongJiDAL
    {
        /// <summary>
        ///表名
        /// <summary>
        private static string TableName = "WebFlowTongJi";
        ...
        /// <param name="ID">ID</param>
        /// <param name="SelectIF">查询字段</param>
        public static WebFlowTongJiEntity Get_99(int ID, string SelectIF)
        {
            try
            {
                //参数Where条件
                ...
                return Get1<WebFlowTongJiEntity>(SelectIF, pramsWhere);
            }
            catch { return null; }
        }
        #endregion
