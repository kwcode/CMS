<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AnnounceClass1_List.aspx.cs" Inherits="WEB.Announce.AnnounceClass1_List" %>
...
<body>
    <div class="g-div-e">
        <div class="t-tool">
            <div class="left">
                <a class="l-btn" onclick="PopShow('AnnounceClass1_Add.aspx',{area: ['500px', '250px']})">
            ...
            <asp:GridView ID="gv_List" DataKeyNames="ID" CssClass="m-table" runat="server" AutoGenerateColumns="False" Width="100%">
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="创建时间" FooterText="创建时间">
                        ...
                        <ItemTemplate>
                            <asp:Literal ID="MaturityDate" runat="server" Text='<%#Eval("CreateTS","{0:yyyy-MM-dd HH:mm}")%>'></asp:Literal>
                        </ItemTemplate>
                    </asp:TemplateField>
                    ...
                    <asp:TemplateField HeaderText="操作" FooterText="操作">
                        ...
                        <ItemTemplate>
                            <a class="td-btn" onclick="PopShow('AnnounceClass1_Modify.aspx?id=<%#Eval("ID")%>',{area: ['500px', '250px']})">
