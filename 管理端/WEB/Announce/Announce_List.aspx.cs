...
{
    public partial class Announce_List : UICommon.BasePage_PM
    {
        ...
        private void BindData()
        {
            ...
            List<Model.ArticleEntity> productList = DAL.AnnounceDAL.GetPageList<Model.ArticleEntity>(PageIndex, PageSize, "*", sqlWhere.ToString());
