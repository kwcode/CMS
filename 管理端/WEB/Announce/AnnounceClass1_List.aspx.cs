...
{
    public partial class AnnounceClass1_List : UICommon.BasePage_PM
    {
        ...
        public static object DoDelete(string jsonlist)
        {
            ...
            {
                int row_Del = DAL.AnnounceDAL.Delete_1(item);
                if (row_Del > 0)
                {
                    index++;
                }
        ...
        private void BindData()
        {
            ...
            TotalCount = DAL.AnnounceClass1DAL.GetRecordCount(sqlWhere.ToString());
            List<Model.ArticleClass1Entity> productList = DAL.AnnounceClass1DAL.GetPageList<Model.ArticleClass1Entity>(PageIndex, PageSize, "*", sqlWhere.ToString());
