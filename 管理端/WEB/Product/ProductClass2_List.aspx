<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProductClass2_List.aspx.cs" Inherits="WEB.Product.ProductClass2_List" %>
...
<body>
    <div class="g-div-e">
        <div class="t-tool">
            <div class="left">
                <a class="l-btn" onclick="PopShow('ProductClass2_Add.aspx',{area: ['500px', '270px']})">
        ...
        <form id="form1" runat="server">
            <asp:GridView ID="gv_List" DataKeyNames="ID" CssClass="m-table" runat="server" AutoGenerateColumns="False" Width="100%"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="一类" FooterText="一类">
                        <ItemStyle HorizontalAlign="Left" Width="180" />
                        <ItemTemplate>
                            <asp:Literal ID="ltProductClass1_ID" runat="server" Text='<%#Eval("ProductClass1_ID")%>'></asp:Literal>
                        </ItemTemplate>
                    </asp:TemplateField>
                    ...
                    <asp:TemplateField HeaderText="操作" FooterText="操作">
                        ...
                        <ItemTemplate>
                            <a class="td-btn" onclick="PopShow('ProductClass2_Modify.aspx?id=<%#Eval("ID")%>',{area: ['500px', '270px']})">
