...
{
    public partial class ProductClass1_List : UICommon.BasePage_PM
    {
        ...
        public static object DoDelete(string jsonlist)
        {
            ...
            {
                int row_Del = DAL.ProductClass1DAL.Delete_1(item);
                if (row_Del > 0)
                {
                    index++;
                }
        ...
        private void BindData()
        {
            ...
            TotalCount = DAL.ProductClass1DAL.GetRecordCount(sqlWhere.ToString());
            List<Model.ProductClass1Entity> productList = DAL.ProductClass1DAL.GetPageList<Model.ProductClass1Entity>(PageIndex, PageSize, "*", sqlWhere.ToString());
