<%@ Page Language="C#" AutoEventWireup="true" ValidateRequest="false" CodeBehind="Product_Modify.aspx.cs" Inherits="WEB.Product.Product_Modify" %>
...
<head id="Head1" runat="server">
    ...
    <script src="/js/layer/layer.js?v=1"></script>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <%--  <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" CssClass="red"
                            ControlToValidate="txtMarketPrice" Display="Dynamic"
                            ErrorMessage="市场价不能为空" SetFocusOnError="True">市场价单位不能为空</asp:RequiredFieldValidator>
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" CssClass="red"
                            ControlToValidate="txtMemberPrice" Display="Dynamic"
                            ErrorMessage="会员价不能为空" SetFocusOnError="True">会员价不能为空</asp:RequiredFieldValidator>--%>
