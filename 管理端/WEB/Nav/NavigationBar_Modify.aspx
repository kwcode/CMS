<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NavigationBar_Modify.aspx.cs" Inherits="WEB.Nav.NavigationBar_Modify" %>
    ...
    <form id="form1" runat="server">
        <div>
            ...
            <table class="ed-table">
                ...
                <tr>
                    <td class="alignright2">SEO标题：</td>
                    <td> 
                        <input type="text" runat="server" style="width:500px" id="txtSEOTitle" />
                    </td>
                </tr>

                <tr>
                    <td class="alignright2">SEO关键字：</td>
                    <td>
                        <input type="text" runat="server" style="width:600px" id="txtSEOKeyWords" />
                    </td>
                </tr>

                <tr>
                    <td class="alignright2">SEO描述：</td>
                    <td>
                        <textarea  runat="server" id="txtSEODescription" ></textarea> 
                    </td>
                </tr>
