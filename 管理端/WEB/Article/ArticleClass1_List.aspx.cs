...
{
    public partial class ArticleClass1_List : UICommon.BasePage_PM
    {
        ...
        public static object DoDelete(string jsonlist)
        {
            ...
            {
                int row_Del = DAL.ArticleClass1DAL.Delete_1(item);
                if (row_Del > 0)
                {
                    index++;
                }
        ...
        private void BindData()
        {
            ...
            List<Model.ArticleClass1Entity> productList = DAL.ArticleClass1DAL.GetPageList<Model.ArticleClass1Entity>(PageIndex, PageSize, "*", sqlWhere.ToString());
