...
namespace WEB.Case
{
    public partial class Case_List : UICommon.BasePage_PM
    {
        ...
        private void BindData()
        {
            ...
            List<Model.ArticleEntity> productList = DAL.CaseDAL.GetPageList<Model.ArticleEntity>(PageIndex, PageSize, "*", sqlWhere.ToString());
