...
namespace WEB.Case
{
    public partial class CaseClass1_List : UICommon.BasePage_PM
    {
        ...
        public static object DoDelete(string jsonlist)
        {
            ...
            {
                int row_Del = DAL.CaseDAL.Delete_1(item);
                if (row_Del > 0)
                {
                    index++;
                }
        ...
        private void BindData()
        {
            ...
            TotalCount = DAL.CaseClass1DAL.GetRecordCount(sqlWhere.ToString());
            List<Model.ArticleClass1Entity> productList = DAL.CaseClass1DAL.GetPageList<Model.ArticleClass1Entity>(PageIndex, PageSize, "*", sqlWhere.ToString());
