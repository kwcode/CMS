<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SolutionClass1_List.aspx.cs" Inherits="WEB.Solution.SolutionClass1_List" %>
...
<body>
    <div class="g-div-e">
        <div class="t-tool">
            <div class="left">
                <a class="l-btn" onclick="PopShow('SolutionClass1_Add.aspx',{area: ['500px', '250px']})">
            ...
            <asp:GridView ID="gv_List" DataKeyNames="ID" CssClass="m-table" runat="server" AutoGenerateColumns="False" Width="100%">
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="操作" FooterText="操作">
                        ...
                        <ItemTemplate>
                            <a class="td-btn" onclick="PopShow('SolutionClass1_Modify.aspx?id=<%#Eval("ID")%>',{area: ['500px', '250px']})">
