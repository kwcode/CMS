<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Solution_List.aspx.cs" Inherits="WEB.Solution.Solution_List" %>
...
<body>
    <div class="g-div-e">
        <div class="t-tool">
            <div class="left">
                <a class="l-btn" target="_blank" href="Solution_Add.aspx">
            ...
            <asp:GridView ID="gv_List" DataKeyNames="ID" CssClass="m-table" runat="server" AutoGenerateColumns="False" Width="100%">
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="操作" FooterText="操作">
                        ...
                        <ItemTemplate>
                            <a class="td-btn" href="Solution_Modify.aspx?id=<%#Eval("ID")%>" target="_blank">
