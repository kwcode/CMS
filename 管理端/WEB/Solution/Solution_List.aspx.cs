...
{
    public partial class Solution_List : UICommon.BasePage_PM
    {
        ...
        private void BindData()
        {
            ...
            List<Model.ArticleEntity> productList = DAL.SolutionDAL.GetPageList<Model.ArticleEntity>(PageIndex, PageSize, "*", sqlWhere.ToString());
