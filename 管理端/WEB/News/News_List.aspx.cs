...
namespace WEB.News
{
    public partial class News_List : UICommon.BasePage_PM
    {
        ...
        private void BindData()
        {
            ...
            List<Model.ArticleEntity> productList = DAL.NewsDAL.GetPageList<Model.ArticleEntity>(PageIndex, PageSize, "*", sqlWhere.ToString());
