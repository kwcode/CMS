...
namespace DAL
{
    ...
    /// Create Time:2016-12-02 21:01
    /// </summary>
    public class ServiceApiConfigurationDAL
    {
        /// <summary>
        ///表名
        /// <summary>
        private static string TableName = "ServiceApiConfiguration";
        ...
        /// <param name="ID">ID</param>
        /// <param name="SelectIF">查询字段</param>
        public static ServiceApiConfigurationEntity Get_99(int ID, string SelectIF)
        {
            try
            {
                //参数Where条件
                ...
                return Get1<ServiceApiConfigurationEntity>(SelectIF, pramsWhere);
            }
            catch { return null; }
        }
        public static ServiceApiConfigurationEntity Get_98(int ValueNum, string SelectIF)
        {
            try
            {
                //参数Where条件
