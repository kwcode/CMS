...
namespace DAL
{
    ...
    public class DomainDAL
    {
        ...
        /// <returns></returns>
        public static int GetUserID(string host)
        {
            SqlParameter[] pramsWhere =
                {
                  DAL.DALUtil.MakeInParam("@DomainName",System.Data.SqlDbType.NVarChar,100,host)
                };
            DomainEntity entity = DAL.DomainDAL.Get1<DomainEntity>("UserID", pramsWhere);
